<div id="contacte" class="relative isolate overflow-hidden bg-cyan-900 py-16 sm:py-24 lg:py-32">
        <div class="bg-[#2362e8] relative z-[1] container m-auto px-6 md:px-12 rounded-xl h-[1000px] w-[1000px] text-center">
