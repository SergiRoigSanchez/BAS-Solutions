...
{{--        </div>--}}
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Contacte</h2>
            <p class="mt-2 text-lg leading-8 text-white">T'interessa el nostre producte? Contacta'ns!</p>
        </div>
        <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div>
                    <label for="first-name" class="block text-sm font-semibold leading-6 text-white">Nom *</label>
                    <div class="mt-2.5">
                ...
                <div>
                    <label for="last-name" class="block text-sm font-semibold leading-6 text-white">Cognoms *</label>
                    <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                    <label for="email" class="block text-sm font-semibold leading-6 text-white">Correu electrònic *</label>
                    <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                    <label for="phone-number" class="block text-sm font-semibold leading-6 text-white">Número de telèfon</label>
                ...
                <div class="sm:col-span-2">
                    <label for="message" class="block text-sm font-semibold leading-6 text-white">Missatge</label>
                    <div class="mt-2.5">
            ...
            <div class="mt-10">
                <button type="submit" class="block w-full rounded-md bg-[#13408a] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#1a4aaf] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Parlem</button>
            </div>
        </form>
    </div>
    <div aria-hidden="true" class="absolute inset-0 w-full h-full bg-[#2362e8] opacity-80"></div>
</div>
