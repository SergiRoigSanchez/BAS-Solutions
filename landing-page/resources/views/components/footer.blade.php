            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                    <ul class="list-disc list-inside space-y-8">
                        <li><a href="/#inici" class="hover:text-sky-400 transition">Inici</a></li>
                        <li><a href="/#preus" class="hover:text-sky-400 transition">Preus</a></li>
                        <li><a href="/#equip" class="hover:text-sky-400 transition">Equip</a></li>
                        <li><a href="/#blog" class="hover:text-sky-400 transition">Blog</a></li>
                        <li><a href="/#faq" class="hover:text-sky-400 transition">FAQ</a></li>
                        <li><a href="/#butlleti" class="hover:text-sky-400 transition">Butlletí</a></li>
                        <li><a href="/#contacte" class="hover:text-sky-400 transition">Contacte</a></li>
                    </ul>

                    <ul role="list" class="space-y-8">
                        <li>
                            <a href="https://github.com/SergiRoigSanchez/BAS-Solutions" class="flex items-center space-x-3 hover:text-sky-400 transition">
                ...
                <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                    ...
                    <span class="flex justify-between text-white">
                        <a href="#" class="font-semibold">Condicions d'ús</a>
