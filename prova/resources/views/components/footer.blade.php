            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                    <ul class="list-disc list-inside space-y-8">
                        <li><a href="#" class="hover:text-sky-400 transition">Inici</a></li>

                        <li><a href="#" class="hover:text-sky-400 transition">Sobre nosaltres</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Guide</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Blocks</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Contacte</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Condicions d'ús</a></li>
                    </ul>
                ...
                <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                    ...
                    <span class="block text-gray-300">Need help? <a href="#" class="font-semibold text-white"> Contacta'ns</a></span>
                </div>
            </div>
        </div>
    </div>
